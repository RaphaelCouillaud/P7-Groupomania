...
exports.deleteMessage = (req, res, next) => {
    Message.findOne({ id: req.params.id }) // On trouve l'objet dans la base de données //
        .then((message) => {
            ...
            fs.unlink(`images/${filename}`, () => { // On le supprime avec fs.unlink //
                Message.destroy({ id: req.params.id }) // Une fois la suppression, on l'indique à la base de données //
...
exports.modifyMessage = (req, res, next) => {
    ...
    Message.update({ id: req.params.id }, { ...messageObject, id: req.params.id }) // On prend l'objet créé et on modifie son identifiant pour correspondre à l'id des paramètres de requêtes //
